...
import { format, parse, startOfWeek, getDay, addMinutes, setHours, setMinutes, isWithinInterval, addDays } from 'date-fns';
...
const SearchDoctors = () => {
  ...
  const generateAvailableSlots = (horaires) => {
    ...
    const endDate = addDays(today, 30); // Créneaux pour les 30 prochains jours
